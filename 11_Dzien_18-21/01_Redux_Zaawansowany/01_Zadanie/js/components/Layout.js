                    ...
                    <div className="column is-one-fifth">
                        <aside className="menu" style={{marginRight: "4rem", marginTop: "1rem"}}>
                            ...
                            <ul className="menu-list">
                                <li><NavLink to={"/"} exact className={({isActive}) => (
                                    isActive ? 'is-active' : ''
                                )}>Strona główna</NavLink></li>
                                <li><NavLink to={"/recipes"} exact className={({isActive}) => (
                                    isActive ? 'is-active' : ''
                                )}>Przepisy</NavLink></li>
                                <li><NavLink to={"/products"} exact className={({isActive}) => (
                                    isActive ? 'is-active' : ''
                                )}>Produkty</NavLink></li>
                            </ul>
                            <p className="menu-label">
                            ...
                            <ul className="menu-list">
                                <li><NavLink to={"/recipes/add"} className={({isActive}) => (
                                    isActive ? 'is-active' : ''
                                )}>Dodaj Przepis</NavLink></li>
                                <li><NavLink to={"/products/add"} className={({isActive}) => (
                                    isActive ? 'is-active' : ''
                                )}>Dodaj Produkt</NavLink></li>
                            </ul>
                        </aside>
                    </div>
